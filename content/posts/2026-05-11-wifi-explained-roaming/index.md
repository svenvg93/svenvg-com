...
![Roaming latency comparison — without 802.11r vs with 802.11r](roaming-latency.svg "Roaming latency comparison — without 802.11r vs with 802.11r")
...
![How 802.11k, r, and v work together during a roam event](roaming-kvr-flow.svg "How 802.11k, r, and v work together during a roam event")
...
![Probe suppression — how band steering works for a dual-band client vs a 2.4 GHz-only IoT device](band-steering-probe.svg "Probe suppression — how band steering works for a dual-band client vs a 2.4 GHz-only IoT device")
...
![Coverage range mismatch — 5 GHz range is smaller than 2.4 GHz, but steering ignores this](band-steering-range.svg "Coverage range mismatch — 5 GHz range is smaller than 2.4 GHz, but steering ignores this")
...
![Band Steering vs 802.11v BSS Transition — mechanism comparison](band-steering-vs-bsstm.svg "Band Steering vs 802.11v BSS Transition — mechanism comparison")
