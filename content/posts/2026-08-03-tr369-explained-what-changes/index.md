...
Multiple Controllers is the model — but how does an Agent find any of them in the first place, and what stops them from stepping on each other once it has? See [TR-369 Explained: DHCP Controller Discovery and Trust]({{< ref "/posts/2026-08-04-tr369-explained-controller-discovery-trust" >}}) for how DHCP options 124/125 hand an Agent its Controller, plus the Role/Permission model that keeps multiple Controllers safely scoped.
