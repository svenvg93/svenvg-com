...
Combined with the ISP gateway and DNS targets from the [previous post]({{< ref "/posts/2026-09-11-smokeping-essentials-targets" >}}), these give you complete coverage to isolate exactly where a problem is.
